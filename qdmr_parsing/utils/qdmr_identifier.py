from .qdmr_operation_identifier import REF, DELIMITER, IdentifyOperatorAggregate, IdentifyOperatorArithmetic, \
    IdentifyOperatorBoolean, IdentifyOperatorComparative, IdentifyOperatorComparison, IdentifyOperatorDiscard,\
    IdentifyOperatorFilter, IdentifyOperatorGroup, IdentifyOperatorIntersect, IdentifyOperatorProject,\
    IdentifyOperatorSelect, IdentifyOperatorSort, IdentifyOperatorSuperlative, IdentifyOperatorUnion
